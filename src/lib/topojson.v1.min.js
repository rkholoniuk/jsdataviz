!function() {
  function t(n, t) {
    ...
    return t.forEach(function(r, e) {
      ...
      var t, e, o = r(n), a = o[0], c = o[1];
      if (t = u[a])if (delete u[t.end], t.push(n), t.end = c, e = i[c]) {
        delete i[e.start];
        var f = e === t ? t : t.concat(e);
        i[f.start = t.start] = u[f.end = e.end] = f
      } else i[t.start] = u[t.end] = t; else if (t = i[c])if (delete i[t.start], t.unshift(n), t.start = a, e = u[a]) {
        delete u[e.end];
        var s = e === t ? t : e.concat(t);
        i[s.start = e.start] = u[s.end = t.end] = s
      } else i[t.start] = u[t.end] = t; else t = [n], i[t.start = a] = u[t.end = c] = t
  ...
  function r(n, r, e) {
    ...
    if (arguments.length > 1) {
      ...
      a(r), s.forEach(arguments.length < 3 ? function(n) {
        c.push(n[0].i)
      } : function(n) {
  ...
  function e(r, e) {
    ...
    return e.forEach(function(n) {
      ...
      type: "MultiPolygon", arcs: f.map(function(e) {
        var o = [];
        if (e.forEach(function(n) {
            n.forEach(function(n) {
              n.forEach(function(n) {
                a[0 > n ? ~n : n].length < 2 && o.push(n)
              })
            })
          }), o = t(r, o), (n = o.length) > 1)for (var u, c = i(e[0][0]), f = 0; n > f; ++f)if (c === i(o[f])) {
          u = o[0], o[0] = o[f], o[f] = u;
          break
        }
        return o
  ...
  function u(n, t) {
    function r(n, t) {
      t.length && t.pop();
      for (var r, e = s[0 > n ? ~n : n], o = 0, i = e.length; i > o; ++o)t.push(r = e[o].slice()), f(r, o);
      0 > n && a(t, i)
    }

    function e(n) {
      return n = n.slice(), f(n, 0), n
    }
    ...
    function c(n) {
      ...
      } : t in l ? {type: t, coordinates: l[t](n)} : null
    }

    var f = v(n.transform), s = n.arcs, l = {
      Point: function(n) {
  ...
  function f(n) {
    ...
    n.forEach(e);
    for (var a in o)for (var f = o[a], s = f.length, l = 0; s > l; ++l)for (var h = l + 1; s > h; ++h) {
      var p, g = f[l], v = f[h];
      (p = i[g])[a = c(p, v)] !== v && p.splice(a, 0, v), (p = i[v])[a = c(p, g)] !== g && p.splice(a, 0, g)
    }
    return i
  }
  ...
  function s(n, t) {
    ...
    var e, o = v(n.transform), i = d(n.transform), u = g(p), a = 0;
    for (t || (t = h), n.arcs.forEach(function(n) {
      var r = [];
      n.forEach(o);
      for (var i = 1, a = n.length - 1; a > i; ++i)e = n.slice(i - 1, i + 2), e[1][2] = t(e), r.push(e), u.push(e);
      n[0][2] = n[a][2] = 1 / 0;
      for (var i = 0, a = r.length; a > i; ++i)e = r[i], e.previous = r[i - 1], e.next = r[i + 1]
    }); e = u.pop();) {
      var c = e.previous, f = e.next;
      e[1][2] < a ? e[1][2] = a : a = e[1][2], c && (c.next = f, c[2] = e[2], r(c)), f && (f.previous = c, f[0] = e[0], r(f))
    }
  ...
  function g(n) {
    function t(t) {
      for (var r = o[t]; t > 0;) {
        var e = (t + 1 >> 1) - 1, i = o[e];
        if (n(r, i) >= 0)break;
        o[i.index = t] = i, o[r.index = t = e] = r
      }
    }

    function r(t) {
      for (var r = o[t]; ;) {
        var e = t + 1 << 1, i = e - 1, u = t, a = o[u];
        if (i < o.length && n(o[i], a) < 0 && (a = o[u = i]), e < o.length && n(o[e], a) < 0 && (a = o[u = e]), u === t)break;
        o[a.index = t] = a, o[r.index = t = u] = r
      }
    }

    var e = {}, o = [];
    return e.push = function() {
      for (var n = 0, r = arguments.length; r > n; ++n) {
        var e = arguments[n];
        t(e.index = o.push(e) - 1)
      }
      return o.length
    }, e.pop = function() {
      var n = o[0], t = o.pop();
      return o.length && (o[t.index = 0] = t, r(0)), n
    }, e.remove = function(e) {
      var i = e.index, u = o.pop();
      return i !== o.length && (o[u.index = i] = u, (n(u, e) < 0 ? t : r)(i)), i
    }, e
  }
  ...
  function v(n) {
    ...
    return function(n, a) {
      a || (t = r = 0), n[0] = (t += n[0]) * e + i, n[1] = (r += n[1]) * o + u
    }
  }
  ...
  function d(n) {
    ...
    return function(n, a) {
      a || (t = r = 0);
      var c = 0 | (n[0] - i) / e, f = 0 | (n[1] - u) / o;
      n[0] = c - t, n[1] = f - r, t = c, r = f
    }
  }
  ...
  var y = {
    version: "1.6.0", mesh: function(n) {
      return u(n, r.apply(this, arguments))
    }, meshArcs: r, merge: function(n) {
      return u(n, e.apply(this, arguments))
    }, mergeArcs: e, feature: o, neighbors: f, presimplify: s
  };
