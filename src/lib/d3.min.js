!function() {
  ...
  function O(n, t) {
    return function(e) {
      ...
      try {n.apply(this, t)} finally {Go.event = r}
    }
  }
  ...
  function Nt(n, t, e, r) {
    ...
    return !ea.XDomainRequest || "withCredentials"in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest), "onload"in c ? c.onload = c.onerror = u : c.onreadystatechange = function() {
      ...
      var t = Go.event;
      Go.event = n;
      try {o.progress.call(i, c)} finally {Go.event = t}
  ...
  function Ot(n) {
    ...
    function e(n, t, e, r) {
      for (var u, i, o, a = 0, c = t.length, s = e.length; c > a;) {
        if (r >= s)return -1;
        if (u = t.charCodeAt(a++), 37 === u) {if (o = t.charAt(a++), i = N[o in cc ? t.charAt(a++) : o], !i || (r = i(n, e, r)) < 0)return -1} else if (u != e.charCodeAt(r++))return -1
      }
      return r
    }
  ...
  try {Qo(ta.childNodes)[0].nodeType} catch (ra) {
    Qo = function(n) {
      for (var t = n.length, e = new Array(t); t--;)e[t] = n[t];
      return e
    }
  }
  try {na.createElement("div").style.setProperty("opacity", 0, "")} catch (ua) {
  ...
  Go.ns = {
    ...
    if (arguments.length < 2) {
      if ("string" == typeof n) {
        ...
        if (t = e.classList) {for (; ++u < r;)if (!t.contains(n[u]))return !1} else for (t = e.getAttribute("class"); ++u < r;)if (!E(n[u]).test(t))return !1;
        return !0
      }
  ...
  ic.year = Ht(function(n) {
    return n = ic.y_value(n), n.setMonth(0, 1), n
  }, function(n, t) {
    n.setFullYear(n.getFullYear() + t)
  }, function(n) {
    return n.getFullYear()
  }), ic.years = ic.year.range, ic.years.utc = ic.year.utc.range, ic.y_value = Ht(function(n) {
    var t = new oc(2e3, 0);
    ...
    return n.getDate() - 1
  }), ic.days = ic.y_value.range, ic.days.utc = ic.y_value.utc.range, ic.dayOfYear = function(n) {
    var t = ic.year(n);
    return Math.floor((n - t - 6e4 * (n.getTimezoneOffset() - t.getTimezoneOffset())) / 864e5)
  }, ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"].forEach(function(n, t) {
    t = 7 - t;
    var e = ic[n] = Ht(function(n) {
      return (n = ic.y_value(n)).setDate(n.getDate() - (n.getDay() + t) % 7), n
    }, function(n, t) {
  ...
  Fs.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? $o : Is, $o.parse = function(n) {
    ...
    return n.getMinutes()
  }), ic.minutes = ic.minute.range, ic.minutes.utc = ic.minute.utc.range, ic.x_value = Ht(function(n) {
    ...
    return n.getHours()
  }), ic.hours = ic.x_value.range, ic.hours.utc = ic.x_value.utc.range, ic.month = Ht(function(n) {
    return n = ic.y_value(n), n.setDate(1), n
  }, function(n, t) {
    n.setMonth(n.getMonth() + t)
  }, function(n) {
    return n.getMonth()
  }), ic.months = ic.month.range, ic.months.utc = ic.month.utc.range;
  var Ys = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6], Zs = [[ic.second, 1], [ic.second, 5], [ic.second, 15], [ic.second, 30], [ic.minute, 1], [ic.minute, 5], [ic.minute, 15], [ic.minute, 30], [ic.x_value, 1], [ic.x_value, 3], [ic.x_value, 6], [ic.x_value, 12], [ic.y_value, 1], [ic.y_value, 2], [ic.week, 1], [ic.month, 1], [ic.month, 3], [ic.year, 1]], Vs = Fs.multi([[".%L", function(n) {
